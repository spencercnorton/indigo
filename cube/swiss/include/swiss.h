...
typedef struct {
	...
	int disableUIAnimations;	// 0 = menu animations on (default)
	int reduceUIAnimations;	// 1 = faster required motion, no decorative travel
	int disablePanelTransparency;	// 0 = translucent menu panels on (default)
